...
function create() {
  ...
  var nextpage = game.add.text(400, 300, "", {
    font: "Arial",
    fontSize: "100px",
    fill: "green",
    align: "center",
  });
  this.text1 = this.add.text(100, 500, "Level:1", {
    font: "Arial",
    fontSize: "20px",
    fill: "green",
  });
...
*/
  ...
  if (
    ...
    if (ball.body.x > this.movexx + 60 && ball.body.x < this.movexx + 190) {
      score_board;
      current_score += 1;
      current_score_text.text = current_score;
      console.log(current_score);
      if (current_score == 1) {
        this.text2 = this.add.text(300, 300, "your promated next level", {
          font: "Arial",
          fontSize: "40px",
          fill: "green",
        });
